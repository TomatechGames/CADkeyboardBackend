...
class BasketItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basket_item" do
    assert_difference("BasketItem.count") do
      post basket_items_url, params: { basket_item: { keyboard_item_id: @basket_item.keyboard_item_id, user_id: @basket_item.user_id } }
    end
  ...
  test "should update basket_item" do
    patch basket_item_url(@basket_item), params: { basket_item: { keyboard_item_id: @basket_item.keyboard_item_id, user_id: @basket_item.user_id } }
